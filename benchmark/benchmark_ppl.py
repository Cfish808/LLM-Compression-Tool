...
def main(args: argparse.Namespace):
    ...
    if args.quantized:
        model = torch.load(args.quantized)
        model.eval()
...
if __name__ == '__main__':
    ...
    parser.add_argument('--model', type=str,default="/ssd/yejinyu/llama2_7b/Llama-2-7b-ms/",  help='Path to the model file or Huggingface model identifier.')
    parser.add_argument('--quantized',type=str,default="/home/yejinyu/llama2_7b/output/llama27b_model_quant_tool.pt", help='Whether to use a quantized model.')
