...
class ModelArguments:
    ...
    teacher_model_name_or_path: Optional[str] = field(
        default=None,
        metadata={"help": "Path to the teacher pretrained model."}
    )
    ...
    r_low_rank: Optional[int] = field(
        default=1,
        metadata={"help": "The rank of matrix in BitLinear layer."},
    )
