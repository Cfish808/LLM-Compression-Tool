...
_import_structure = {
    "configuration_bitllama": ["LLAMA_PRETRAINED_CONFIG_ARCHIVE_MAP", "BitLlamaConfig"],
}
...
if TYPE_CHECKING:
    from .configuration_bitllama import LLAMA_PRETRAINED_CONFIG_ARCHIVE_MAP, BitLlamaConfig
