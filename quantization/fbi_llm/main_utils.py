...
from quantization.fbi_llm.model_utils.modeling_llama import LlamaForCausalLM
from pathlib import Path


def load_jsonl_examples(calibrate,
                        n_examples,
                        shuffle,
    ...
    for example_idx, line in tqdm.tqdm(enumerate(calibrate)):
        if example_idx in examples:
            examples[example_idx] = line
