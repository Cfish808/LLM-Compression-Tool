class BaseQuantizer(object):
    def __init__(self, quant_hub_linear, w_bits=16, a_bits=16, offload=None, device=None, a_qtype="per_tensor",
                 w_qtype="per_group", w_has_zero=False, a_has_zero=False, w_unsign=True, a_unsign=True,
