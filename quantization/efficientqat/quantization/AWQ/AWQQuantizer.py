...
from quantization import Precision, PRECISION_TO_BIT
from quantization.base import BaseQuantizer
from utils.memory import clear_mem
from utils.util import track_input_hook_to_cpu


class LinearAwqQuantizer(BaseQuantizer):
    def __init__(self, quant_hub_linear, w_has_zero=True, w_unsign=True, groupsize=128,  auto_scale=True, auto_clip=True, w_qtype='per_group', wbit=Precision.FP16, abit=Precision.FP16, offload='cpu', device='cuda',**kwarg) -> None:
