...
class GPTQForCausalLM(nn.Module, PushToHubMixin):
    layer_type: str = None
    ...
    def __init__(
        ...
        self.layers_block_name = layers_block_name
        self.outside_layer_modules = outside_layer_modules
...
__all__ = ["GPTQForCausalLM", "BaseQuantizeConfig"]
