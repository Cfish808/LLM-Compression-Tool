...
def get_my_model(model, model_fp, blocksize2=256, tau_range=0.1, tau_n=51):
...
def _replace_with_ours_lora_4bit_linear(
    ...
    for name, module in model.named_children():
        ...
        # Update progress
        processed_modules += 1
        if processed_modules % 10 == 0 or processed_modules == total_modules:
            print(f"Processing modules: {processed_modules}/{total_modules} ({processed_modules/total_modules*100:.1f}%)")
