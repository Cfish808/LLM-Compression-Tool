...
from my_datasets import get_wikitext2, get_ptb, get_c4, get_subjects_ceval, get_testdaset_ceval, get_fewshot_ceval, \
    extract_cot_answer_ceval, classifi_results_ceval, get_subjects_cmmlu, get_testdata_cmmlu, get_fewshot_cmmlu, \
    extract_cot_answer_cmmlu, classifi_results_cmmlu, get_testdata_boss, get_fewshot_boss, get_zeroshot_boss
from my_datasets.load_lmeval import get_testdata
